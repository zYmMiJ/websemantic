...
do
   bash scripts/runexp.sh -d 4-10000-${mod}-im80 java -Dlog.level=INFO -cp ${JPATH} fr.inria.exmo.lazylavender.engine.Monitor ${OPT} ${LOADOPT} -DrevisionModality=${mod} -DimmediateRatio=80
