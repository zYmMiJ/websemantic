...
EXPE="Revision of networks of ontologies with most specific strenghening (fixed implementation)"

HYPOTHESIS="Strenghening improves recall over expansion even better when implementation is fixed"

SETTING="Repeating [[${VARIATIONOF}]] replaying the runs of [[20180308-NOOR]] with most specific strengthening; the software has been improved for taking into account equivalence correspondences"
